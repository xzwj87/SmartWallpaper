//package com.samsung.app.smartwallpaper.manager;
//import java.io.File;
...
//
//    public static String getInstalledApkVersion(){
//        String version=null;
//
//        return version;
//    }
...
//
//    }
//    public boolean downloadApk(String version){
//
//    }
...
//        public void run() {
//            try {
//                String apkName = "SmartWallpaper_"+mUpdate.getVersionName()+".apk";
//                String tmpApk = "SmartWallpaper_"+mUpdate.getVersionName()+".tmp";
//                //判断是否挂载了SD卡
//                String storageState = Environment.getExternalStorageState();
//                if(storageState.equals(Environment.MEDIA_MOUNTED)){
//                    savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/SmartWallpaper/Update/";
