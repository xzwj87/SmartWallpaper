...
public class Action {
    ...
    public static final String ACTION_UPLOAD_WALLPAPER = "UploadWallpaperToServer";
    public static final String ACTION_FAVORITE_WALLPAPER = "FavoriteWallpaper";
    public static final String ACTION_FAVORITE_WALLPAPER_LIST = "FavoriteWallpaperList";
    public static final String ACTION_RESTORE_WALLPAPER = "RestoreWallpaper";
