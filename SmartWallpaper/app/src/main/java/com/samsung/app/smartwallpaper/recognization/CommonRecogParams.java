package com.samsung.app.smartwallpaper.recognization;
...
public class CommonRecogParams {
    ...
    public Map<String, Object> fetch(SharedPreferences sp) {
        ...
        //if (sp.getBoolean("_tips_sound", false)) { // 声音回调
            map.put(SpeechConstant.SOUND_START, R.raw.recognition_start);
            map.put(SpeechConstant.SOUND_END, R.raw.speech_end);
            map.put(SpeechConstant.SOUND_SUCCESS, R.raw.recognition_success);
            map.put(SpeechConstant.SOUND_ERROR, R.raw.recognition_error);
            map.put(SpeechConstant.SOUND_CANCEL, R.raw.recognition_cancel);
        //}
