...
public class ASRProgressBar extends View {
    ...
    public ASRProgressBar(Context context) {
        super(context);
        paint = new Paint();
        initView();
    }

    public ASRProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        paint = new Paint();
        initView();
    }
    ...
    public void setTheme(int theme) {
        final boolean isDeepStyle = ASRDialogTheme.isDeepStyle(theme);
