...
public class WallpaperGridAdapter extends RecyclerView.Adapter<WallpaperGridAdapter.WallpaperViewHolder> implements
            ...
            case R.id.fl_item:
                if(hasTap){//第二次点击
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if(!doubleTap){//单击
                                WallpaperListActivity.getInstance().showWallpaperPreview(pos);
                            }else{//双击
                                if(wallpaperItem.hasVoteUp()){
                                    doubleTap = false;
                                    hasTap = false;
                                ...
                                startVoteUpAnimation(voteUpView);
    ...
    private void startVoteUpAnimation(final View targetView){
    ...
    private void startFavoriteAnimation(final View targetView){
